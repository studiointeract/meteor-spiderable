          ...
          if (data) {
            switch(filetype) {
              ...
              case 'js':
                ...
                break;
              case 'css':
                _staticHeaders += '\n<link rel="stylesheet" type="text/css" class="__meteor-css__" href="/' + file + '">';
                break;
            }
          }
        } catch(e) {
...
Meteor.startup(function() {
  ...
  // Load boilerplate for studiointeract:spiderable.
  var packagePath = './assets/packages/studiointeract_spiderable';
  findAndLoadAssets(packagePath, 'html', false);
  findAndLoadAssets(packagePath, 'js', false);

  // Load templates.
  findAndLoadAssets('../web.browser/app/client', 'js');

  // Load package client code.

  findAndLoadAssets('../web.browser/packages', 'js');

  // Load precompiled css.
